...
:local targetfile "mikrotik_test.rsc"   
...
/system logging action add disk-file-count=1 disk-file-name=pub/perfectrestore.log disk-lines-per-file=4096 name=perfectrestore target=disk
